...
module.exports = function(t) {
  ...
  function addExpressionToPath(path, expression) {
    ...
    } else if (t.isAssignmentExpression(parentPath) && parentPath.node.operator !== '+=') {
      parentPath.replaceWith(expression);
    } else if (t.isBinaryExpression(parentPath) || (t.isAssignmentExpression(parentPath) && parentPath.node.operator === '+=')) {
